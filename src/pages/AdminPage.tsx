...
import { Shield, Users, Leaf, Sun, Moon } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-black text-white">EcoDrop Admin Console</span>
            </div>
            ...
            <div className="flex items-center space-x-2">
              ...
              >
                <Users className="h-3.5 w-3.5 mr-1" /> Volunteer Desk
              </Button>
